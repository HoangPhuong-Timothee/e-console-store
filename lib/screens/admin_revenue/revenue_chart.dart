...
class _ChartScreenState extends State<ChartScreen> {
  ...
  Widget buildbill(List<Bill> list) {
    ...
    for (int i = 0; i < list.length; i++) {
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 1) {
        jan = jan + list[i].total;
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 2) {
        feb = feb + list[i].total;
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 3) {
        mar = mar + list[i].total;
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 4) {
        apr = apr + list[i].total;
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 5) {
        may = may + list[i].total.toDouble();
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 6) {
        jun = jun + list[i].total;
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 7) {
        jul = jul + list[i].total;
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 8) {
        agu = agu + list[i].total;
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 9) {
        sep = sep + list[i].total;
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 10) {
        oct = oct + list[i].total;
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 11) {
        nov = nov + list[i].total;
      }
      if (list[i].datetime.year.toString() == searchController.text &&
          list[i].datetime.month == 12) {
