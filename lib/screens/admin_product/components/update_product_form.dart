  ...
  Widget build(BuildContext context) {
    ...
    final addButton = Material(
      ...
      child: MaterialButton(
          ...
          onPressed: () async {
            final check = await Products.checkProductbyid(
                productCodeEditingController.text);
            if (check) {
              ...
              if (priceEditingController.text != "") {
                FirebaseFirestore.instance
                    ...
                    .doc(productCodeEditingController.text)
                    .update({
                  "price": double.tryParse(priceEditingController.text)
                }).then(
                        (value) =>
                            print("DocumentSnapshot successfully updated!"),
                        onError: (e) => print("Error updating document $e"));
              ...
              List<String> list = await Products.getProductsbyid(
                  productCodeEditingController.text);
              if (image1EditingController.text != "") {
                ...
                Fluttertoast.showToast(
                    msg: " Update first image successfully :) ");
              }
              if (image2EditingController.text != "") {
                ...
                Fluttertoast.showToast(
                    msg: " Update second image successfully :) ");
              }
              if (image3EditingController.text != "") {
                ...
                Fluttertoast.showToast(
                    msg: " Update third image successfully :) ");
              }
              if (image4EditingController.text != "") {
                ...
                Fluttertoast.showToast(
                    msg: " Update fourth image successfully :) ");
              }
